    ...
    <Popover className="relative">
      ...
      <PopoverPanel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden ">
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]">
          ...
          <div className="pr-4 text-xl font-bold">Takipçi istekleri</div>
        </button>
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-5 hover:bg-[color:var(--background-secondary)]">
          <div className="w-[1.641rem] h-[1.641rem] relative">
            <svg viewBox="0 0 24 24" className="h-[1.5rem]">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <DisclosureButton className="flex items-center justify-between w-full p-4 font-bold hover:bg-[color:var(--background-secondary)] transition-colors">
                Ayarlar ve Destek
                <svg
                  viewBox="0 0 24 24"
